...
const PACKAGE_ID = "modules/pf2e-aura-reminder";
...
const config = Vite.defineConfig(({ command, mode }): Vite.UserConfig => {
    ...
    if (command === "serve") {
        ...
        fs.writeFileSync(
            "./styles/pf2e-aura-reminder.css",
            `/** ${message} */\n`,
        );
        fs.writeFileSync(
            "./pf2e-aura-reminder.mjs",
    ...
    return {
        base: command === "build" ? "./" : `/modules/pf2e-aura-reminder/`,
        publicDir: "static",
        define: {
        ...
        build: {
            ...
            rollupOptions: {
                ...
                output: {
                    ...
                    entryFileNames: "pf2e-aura-reminder.mjs",
                    manualChunks: {
        ...
        server: {
            ...
            open: false,
            proxy: {
                "^(?!/modules/pf2e-aura-reminder/)": "http://localhost:30000/",
                "/socket.io": {
...
function deleteLockFilePlugin(): Vite.Plugin {
    return {
        ...
        writeBundle(outputOptions) {
            ...
            const lockFile = path.resolve(outDir, "pf2e-aura-reminder.lock");
            fs.rmSync(lockFile);
        },
    };
}
